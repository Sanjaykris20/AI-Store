...
def cart_item_row(item: dict) -> rx.Component:
    ...
    return rx.hstack(
        ...
        rx.spacer(),
        rx.text(price_total, font_weight="bold", color="blue.400", size="4"),
                ...
                rx.cond(
                    ...
                    rx.card(
                        rx.vstack(
                            ...
                            rx.divider(margin_y="2rem", opacity="0.1"),
                            
                            rx.hstack(
                                rx.heading("Total:", size="6", color="white"),
                                rx.spacer(),
                                rx.heading(f"₹{CartState.total_price}", size="7", color="blue.400"),
                                width="100%",
                                padding_x="1rem"
                            ),
                            ...
                            rx.hstack(
                                ...
                                rx.spacer(),
                                rx.link(rx.button("Proceed to Checkout", color_scheme="blue", size="3"), href="/checkout"),
                                width="100%",
                                padding="1rem",
                                margin_top="2rem"
                            ),
